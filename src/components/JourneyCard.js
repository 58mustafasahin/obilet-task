                ...
                <CardBody style={{ padding: '4px 0px' }}>
                    <Row className='pt-1 pb-1' style={{ borderBottom: '1px solid lightgray' }}>
                        ...
                        <Col style={{ margin: '0 auto', display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                            <Button style={{ backgroundColor: item["available-seats"] == 0 ? 'gray' : '#d23b38', border: 'none' }}>
                                Koltuk Seç
                            </Button>
                            <CardText style={{ fontSize: '13px' }}>
                                {0 < item["available-seats"] && item["available-seats"] < 10 && `Son ${item["available-seats"]} Koltuk`}
                            </CardText>
                        </Col>
                    </Row>
                    <Row className='mt-3'>
